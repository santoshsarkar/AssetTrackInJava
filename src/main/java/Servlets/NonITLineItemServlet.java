 ...
 * @author santo
 */
public class NonITLineItemServlet extends HttpServlet {
       ...
       try
    {
      ...
      String query = "select * from non_it_goods_lineitem where non_it_goods_id="+ request.getParameter("id");
      ...
      String query2 = " select * from non_it_goods where non_it_goods_id="+ request.getParameter("id");
  ...
  out.println("<h2><center>BSO Complete this section</center></h2>");	    
   ...
   out.println("<td><b>make_model_number</b></td>");
   out.println("<td><b>decal_number</b></td>");

...
import hcd.ca.gov.assets.util.JsfUtil1;
import hcd.ca.gov.assets.util.JsfUtil1.PersistAction;
...
@Named("assetsController1")
@SessionScoped
public class AssetsController1 implements Serializable {
    ...
    public void create() {
        ...
        if (!JsfUtil1.isValidationFailed()) {
    ...
    public static class AssetsControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            AssetsController1 controller = (AssetsController1) facesContext.getApplication().getELResolver().
